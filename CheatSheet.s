...
//***********************************************************************************************************
// Registers: R0, R1 ... R12. R13 = SP, R14 = LR, R15 = PC    // Cmments should be e-mailed to Lasse Natvig.
...
.global _start
_start: // Note: the program "does nothing" and is by will made rather compact to fit in one page.
...
nice:
	...
	MOV R2, #1234 
	POP {R1-R4}  // R1-R4 are now restored from the state PUSHed to stack 2 instructions above
	LDR R0, =0xFFFF0000
	LDR R1, =0x0000FFFF
	...
	PUSH {R2} // R2 is caller-saved, and used below. Will be changed by PUT_JTAG
